...
{% docs gcp_billing_export_resource_v1_<BILLING_ACCOUNT_ID> %}
...
{% docs project.ancestors.display_name %}
...
{% docs usage.amount_in_pricing_units %}

The quantity of usage.pricing_unit used.

{% enddocs %}

{% docs usage.pricing_unit %}
...
{% docs adjustment_info.description %}

A description of the adjustment and its cause.

{% enddocs %}

{% docs adjustment_info.mode %}
